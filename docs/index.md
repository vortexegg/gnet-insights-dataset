...
*You introduce the main question, topic, or dataset that you are exploring in the blog post and communicate why it's important in a clear and engaging manner*

The GNET Insights Dataset is a collection of the Insight blog posts published on the The Global Network on Extremism and Technology's [GNET Research blog](https://gnet-research.org). The purpose of this dataset is to provide researchers with a source of data for conducting bibliometric and information studies data research about publication practices within the intersecting fields of the study of technology and terrorism and violent extremism.
...
The purpose of the Curating the GNET Insights Dataset project is to create a dataset of blog posts, authorship, publication date, and tag data from the research "insights" published on the Global Network on Extremism and Technology Research Blog. The field of terrorism studies, and particularly the intersection of the study of terrorism and digital platforms, is in need of ongoing information studies that assess trends in the topics and authorship within this research domain. GNET is a rapid research blog that produces topical research on the technology and terrorism landscape, and is thus ripe for text mining to conduct bibliometric and topical analysis.
